...
public class GeodeSnack extends Item {
    public GeodeSnack(Settings settings) {
        super(settings);
    }
...
//                player.damage(ModDamageSources.DIRT_SNACK, 1f);
            ...
            if ( !world.isClient ) {
                ...
                LootTable lootTable = lootManager.getTable(new Identifier(RenewEverythingMod.MOD_ID, "snacks/geode_snack_loot"));
